    ...
    <div className="min-h-screen bg-slate-900 flex flex-col">
      ...
      <header className="bg-slate-800/80 backdrop-blur-sm border-b border-slate-700/50 px-4 py-3 flex items-center justify-between">
        ...
        <div className="hidden sm:flex items-center gap-4">
          <div className="text-center">
            <p className="text-purple-400 font-bold text-lg leading-none">
              {vacancies.length}
            </p>
      ...
      <div className="bg-slate-800/50 border-b border-slate-700/50 px-4">
        <div className="flex gap-1">
          {[
            { key: "chat" as ActiveTab, label: "💬 Chat com IA" },
            {
              key: "mindmap" as ActiveTab,
              label: loadingMindMap
                ? "✨ Analisando seu perfil..."
                : `🔍 Vagas${vacancies.length > 0 ? ` (${vacancies.length})` : ""}`,
            },
          ].map((tab) => (
            <button
              key={tab.key}
            ...
            <div className="border-t border-slate-700/50 bg-slate-800/50 p-4">
              ...
              <div className="flex gap-3 items-end">
                ...
                <button
                  ...
                  className="w-11 h-11 bg-purple-600 hover:bg-purple-500 disabled:bg-slate-700 disabled:text-slate-500 text-white rounded-xl flex items-center justify-center transition-colors shrink-0"
                >
                  {isLoading ? (
                    <svg
